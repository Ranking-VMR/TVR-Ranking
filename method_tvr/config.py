...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--ctx_mode", type=str, help="which context to use a combination of [video, sub, tef]",
                                 choices=["video", "sub", "video_sub", "tef", "video_tef", "sub_tef", "video_sub_tef"])
